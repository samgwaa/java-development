public class LoopExercise {
   ...
   /*  System.out.println("Welcome to Java");
     ...
     int loopCounter = 50;
     int sum = 0;
     while (loopCounter <= 100){ //every time the loop runs it is called an iteratio
         sum += loopCounter;
         loopCounter++;
    ...
    /* Create a while loop that prints the numbers from 1000 to 10000
     ...
     do...while loop - while loop checks the condition and then executes but the do.
     ...
     do...while we would use if we want to do something and then check if something
      */
     ...
     int sum = 0;
     for(int i = 1; i <= 10; i++) {
         if (i % 4 == 0) { //If i is divisible by 3 meaning no remainder when we div
